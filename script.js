...
const malesCount = data.filter(person => person.gender === 'Male').length;
console.log('Vyrų yra:', malesCount);

const newerThan2000 = data
    .filter(person => person.car_year > 2000)
    .map(person => person.id);

console.log('Žmonės, kurių automobiliai naujesni nei 2000 metų:', newerThan2000);
